...
<div id="container">
  <h2>No route matches [GET] &quot;/custombox.legacy.min.js&quot;</h2>

  
<p><code>Rails.root: /Users/samalmeida/Desktop/travel-language-learning</code></p>
...
<table id='route_table' class='route_table'>
  ...
  <td data-route-name='welcome_about'>
      welcome_about<span class='helper'>_path</span>
  </td>
  <td>
    GET
  </td>
  <td data-route-path='/welcome/about(.:format)'>
    /welcome/about(.:format)
  </td>
  <td>
    <p>welcome#about</p>
  </td>
...
<tr class='route_row' data-helper='path'>
  ...
  <td>
    <p>registrations#create</p>
  </td>
</tr>
<tr class='route_row' data-helper='path'>
  <td data-route-name='learning_index'>
      learning_index<span class='helper'>_path</span>
  </td>
  <td>
    GET
  </td>
  <td data-route-path='/learning/index(.:format)'>
...
<tr class='route_row' data-helper='path'>
  <td data-route-name='learning'>
      learning<span class='helper'>_path</span>
  </td>
  <td>
    GET
  </td>
  <td data-route-path='/learning(.:format)'>
    /learning(.:format)
  </td>
  <td>
    <p>learning#splash</p>
...
<tr class='route_row' data-helper='path'>
  <td data-route-name='conversation_messages'>
      conversation_messages<span class='helper'>_path</span>
  </td>
  <td>
    GET
  </td>
  <td data-route-path='/conversations/:conversation_id/messages(.:format)'>
    /conversations/:conversation_id/messages(.:format)
  </td>
  <td>
    <p>messages#index</p>
  </td>
...
<tr class='route_row' data-helper='path'>
  <td data-route-name='new_conversation_message'>
      new_conversation_message<span class='helper'>_path</span>
  </td>
  <td>
    GET
  </td>
  <td data-route-path='/conversations/:conversation_id/messages/new(.:format)'>
    /conversations/:conversation_id/messages/new(.:format)
  </td>
  <td>
    <p>messages#new</p>
  </td>
...
<tr class='route_row' data-helper='path'>
  <td data-route-name='edit_conversation_message'>
      edit_conversation_message<span class='helper'>_path</span>
  </td>
  <td>
    GET
  </td>
  <td data-route-path='/conversations/:conversation_id/messages/:id/edit(.:format)'>
    /conversations/:conversation_id/messages/:id/edit(.:format)
  </td>
  <td>
    <p>messages#edit</p>
  </td>
...
<tr class='route_row' data-helper='path'>
  <td data-route-name='conversation_message'>
      conversation_message<span class='helper'>_path</span>
  </td>
  <td>
    GET
  </td>
  <td data-route-path='/conversations/:conversation_id/messages/:id(.:format)'>
    /conversations/:conversation_id/messages/:id(.:format)
  </td>
  <td>
    <p>messages#show</p>
  </td>
...
<tr class='route_row' data-helper='path'>
  ...
  <td>
    <p>messages#destroy</p>
  </td>
</tr>
<tr class='route_row' data-helper='path'>
  <td data-route-name='conversations'>
      conversations<span class='helper'>_path</span>
  </td>
  <td>
    GET
  </td>
  <td data-route-path='/conversations(.:format)'>
    /conversations(.:format)
  </td>
  <td>
    <p>conversations#index</p>
  </td>
</tr>
<tr class='route_row' data-helper='path'>
  <td data-route-name=''>
  ...
  <td>
    <p>conversations#create</p>
  </td>
</tr>
<tr class='route_row' data-helper='path'>
  <td data-route-name='new_conversation'>
      new_conversation<span class='helper'>_path</span>
  </td>
  <td>
    GET
  </td>
  <td data-route-path='/conversations/new(.:format)'>
    /conversations/new(.:format)
  </td>
  <td>
    <p>conversations#new</p>
  </td>
</tr>
<tr class='route_row' data-helper='path'>
  <td data-route-name='edit_conversation'>
      edit_conversation<span class='helper'>_path</span>
  </td>
  <td>
    GET
  </td>
  <td data-route-path='/conversations/:id/edit(.:format)'>
    /conversations/:id/edit(.:format)
  </td>
  <td>
    <p>conversations#edit</p>
  </td>
</tr>
<tr class='route_row' data-helper='path'>
  <td data-route-name='conversation'>
      conversation<span class='helper'>_path</span>
  </td>
  <td>
    GET
  </td>
  <td data-route-path='/conversations/:id(.:format)'>
    /conversations/:id(.:format)
  </td>
  <td>
    <p>conversations#show</p>
  </td>
</tr>
<tr class='route_row' data-helper='path'>
  <td data-route-name=''>
...
<div class="details">
  ...
  <div id="session_dump" style="display:none"><pre>_csrf_token: &quot;P7zZCBEDsfyeLjahUplTqLcoA1ztAmjC0ZCCeAEp/sQ=&quot;
flash: {&quot;discard&quot;=&gt;[], &quot;flashes&quot;=&gt;{&quot;notice&quot;=&gt;&quot;Signed in successfully.&quot;}}
session_id: &quot;4d3752cd6287155e1336206682c8870b&quot;
user_return_to: &quot;/users/1&quot;
warden.user.user.key: [[16], &quot;$2a$11$kY6OkCI3CbDPK3s2yKjaFu&quot;]</pre></div>
</div>
...
<div id="console"
  ...
  data-session-id='73b6da53d97d45c5890bdb3182b20742'
  data-prompt-label='>> '>
</div>
